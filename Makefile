...
pkglibexecdir = $(libexecdir)/pkg-config
...
CONFIG_CLEAN_FILES = pkg.m4 config.h.win32
...
am__DIST_COMMON = $(dist_man_MANS) $(srcdir)/Makefile.in \
	...
	$(srcdir)/config.h.win32.in $(srcdir)/pkg.m4.in AUTHORS \
...
ACLOCAL = ${SHELL} /Users/yunxing/programming/pkg-config/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /Users/yunxing/programming/pkg-config/missing autoconf
AUTOHEADER = ${SHELL} /Users/yunxing/programming/pkg-config/missing autoheader
AUTOMAKE = ${SHELL} /Users/yunxing/programming/pkg-config/missing automake-1.15
AWK = awk
CC = gcc
...
GCOV = 
GCOV_CFLAGS = 
GLIB_CFLAGS = -I/usr/local/Cellar/glib/2.46.2/include/glib-2.0 -I/usr/local/Cellar/glib/2.46.2/lib/glib-2.0/include -I/usr/local/opt/gettext/include
GLIB_LIBS = -L/usr/local/Cellar/glib/2.46.2/lib -L/usr/local/opt/gettext/lib -lglib-2.0 -lintl
GREP = /usr/bin/grep
...
LTLIBOBJS = 
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /Users/yunxing/programming/pkg-config/missing makeinfo
MANIFEST_TOOL = :
...
TESTS_SHELL = /bin/bash
VERSION = 0.29.1
WARN_CFLAGS = -g -Wall -O2
WINE = 
abs_builddir = /Users/yunxing/programming/pkg-config
abs_srcdir = /Users/yunxing/programming/pkg-config
abs_top_builddir = /Users/yunxing/programming/pkg-config
abs_top_srcdir = /Users/yunxing/programming/pkg-config
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /Users/yunxing/programming/pkg-config/install-sh
...
pdfdir = ${docdir}
prefix = /Users/yunxing/programming/pkg-config/_build
